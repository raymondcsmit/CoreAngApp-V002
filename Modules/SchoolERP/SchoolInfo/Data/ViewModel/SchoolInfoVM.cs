...
namespace SchoolInfo.Module.Data.ViewModel
{
 
    public class SchoolInfoVM : BaseEntity
    {
        [Display(Name = "SL")]
        ...
        public static implicit operator SchoolInfoVM(SchoolInfoEntity _CompanyInfo)
        {
            return new SchoolInfoVM
            {
                Id = _CompanyInfo.Id,
        ...
        public static implicit operator SchoolInfoEntity(SchoolInfoVM vm)
        {
            if (vm.Id != 0)
